...
CREATE OR REPLACE PACKAGE PKG_WEEKLY_STAT AS
    PROCEDURE CALCULATE_WEEKLY_STAT;
END PKG_WEEKLY_STAT;

CREATE OR REPLACE PACKAGE BODY PKG_WEEKLY_STAT AS

    PROCEDURE CALCULATE_WEEKLY_STAT IS
    ...
    BEGIN
        SELECT
            ...
            SUM(B.TOTAL_PRICE),
            COUNT(BS.SERVICE_ID),
            SUM(S.PRICE * BS.QUANTITY) INTO V_NUMBER_BOOKING,
            V_REVENUE_BOOKING,
            V_NUMBER_SERVICES,
            V_REVENUE_SERVICES
        FROM
...
BEGIN
    DBMS_SCHEDULER.create_job (
        ...
        job_action      => 'BEGIN PKG_WEEKLY_STAT.CALCULATE_WEEKLY_STAT; END;',
